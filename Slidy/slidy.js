...
var helpText = "Navigate with space bar, Cursor Left/Right, " +
...
function startup()
{
   ...
   setLocation();
   reSize(); // to 1024x768, to fit the Uris Auditorium projector limits
   resized();
   showToolbar();
}
...
function keyDown(event)
{
    ...
    else if (key == 37 | key == 40) // Left arrow; 40=^[[B is my addition [Shimon]
    {
       previousSlide(true);
       return cancel(event);
    }
    ...
    else if (key == 39 | key == 38) // Right arrow; 38=^[[A is my addition [Shimon]
    {
       nextSlide(true);
       return cancel(event);
    }
...
//   if (target.nodeType == 3)
  ...
  // [Shimon, 7/14/08] make right click go to previous slide:
...
function findCopyright()
{
   ...
   for (var i = 0; i < meta.length; ++i)
   {
    ...
    return "made public under <a rel=\"license\" href=\"https://creativecommons.org/licenses/by-nc/4.0/\" target=new>Creative Commons Attribution-NonCommercial license 4.0</a> <img rel=\"cc:requires\" href=\"https://creativecommons.org/ns\" class=\"license sa\" src=\"../Slidy/sa.png\" height=10> 2004-2025 Shimon Edelman";
}
...
function addToolbar()
{
   ...
   else // IE so need to work around its poor CSS support
   {
      ...
      var resizeTo = document.createElement("a");
      resizeTo.setAttribute("href", "javascript:reSize()");
      resizeTo.setAttribute("title", "resize to 1024x768");
      resizeTo.innerHTML = "resize?";
      toolbar.appendChild(resizeTo);
